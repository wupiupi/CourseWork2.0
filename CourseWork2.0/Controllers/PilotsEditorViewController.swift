...
final class PilotsEditorViewController: UIViewController {
    ...
    var headerView = AuthHeaderView(
        title: "Attention",
        subtitle: "You want to delete pilot from a list."
    )
    ...
    private func removeFromDatabase(field: String) {
        ...
        let docRef = Firestore.firestore().collection("pilots").document("XxsFTdkaQuKUDPTXeHwX")
    ...
    private func addToDatabase(field: String, value: String) {
        ...
        let documentRef = db.collection("pilots").document("XxsFTdkaQuKUDPTXeHwX")
    ...
    @objc private func didTapDone() {
        ...
        if areWeAdding {
            ...
            addToDatabase(field: value, value: amount)
        } else if !areWeAdding {
