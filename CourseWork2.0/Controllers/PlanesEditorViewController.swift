//
//  PlanesEditorViewController.swift
//  CourseWork2.0
//
...
final class PlanesEditorViewController: UIViewController {
    ...
    var headerView = AuthHeaderView(
        title: "Attention",
        subtitle: "You want to delete plane from a list."
    )
    ...
    private func removeFromDatabase(field: String) {
        ...
        let docRef = Firestore.firestore().collection("planes").document("NZJSqZ8lynrkmapfl1nw")
    ...
    private func addToDatabase(field: String, value: Int) {
        ...
        let documentRef = db.collection("planes").document("NZJSqZ8lynrkmapfl1nw")
